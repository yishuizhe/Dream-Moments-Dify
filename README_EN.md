...
The current web UI is a single console at `http://127.0.0.1:8501/console`. The old dashboard, config page, and quick-setup page are no longer part of the project.
